...
This is an ad-hoc script to run hyppo on the simulated dataset from simphy, and to produce some 
basic statistics out of the results.

This script is not intended for general use.  
Hence the extremely sparse documentation.
If you want to use this, this script should be in the same directory as hyppo.py.

The file data_commands.txt has lots of usage examples.
'''
###############################################################################################################################################
