...
#This script was used to run simphy, multiply the duplication branches (using sgutils), and then run indelible
#Just pass in the base directory --simphydir, the --conf filename and the output --simphyoutdir.  The flag --use_aa simulates amino acid sequences.
...
for i in range(nbreplicates):
	...
	#NOTE ML: WE DON'T DO THIS ANYMORE
	'''
	print("chdir: " + cwd)
	os.chdir(cwd)
