...
int main(int argc, char *argv[])
{
    ...
    if (baseDir == "")
    {
        //cout<<"Please specify indir with -d (the directory that contains the simphy trees)"<<endl;

        cout<<"This main purpose of this program is to parse the output from trees "<<
               "generated by simphy.  It will: "<<endl<<
               "create a mult subdirectory in the base dir specified with -d"<<endl<<
               ...
               "then make a control file for indelible."<<endl;
